                ...
                {creator.social_links && (
                  <div style={{ display: 'flex', gap: '16px' }}>
                    {creator.social_links.x || creator.social_links.twitter ? (
                      <a href={creator.social_links.x || creator.social_links.twitter} target="_blank" rel="noopener noreferrer" className="v2-social-link" style={{ color: 'var(--v2-text-variant)', display: 'flex', transition: 'color 0.2s' }}>
                    ...
                    {creator.social_links.instagram ? (
                      <a href={creator.social_links.instagram} target="_blank" rel="noopener noreferrer" className="v2-social-link" style={{ color: 'var(--v2-text-variant)', display: 'flex', transition: 'color 0.2s' }}>
                    ...
                    {creator.social_links.youtube ? (
                      <a href={creator.social_links.youtube} target="_blank" rel="noopener noreferrer" className="v2-social-link" style={{ color: 'var(--v2-text-variant)', display: 'flex', transition: 'color 0.2s' }}>
